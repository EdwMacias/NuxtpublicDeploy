...
use App\Http\Middleware\AdministradorEmpresaIsValid;
...
use App\Models\erp\erp_permisos_roles;
...
Route::group(['middleware' => ['jwt.verify']], function () {
    ...
    Route::middleware(LoginSesionActive::class)->group(function () {
        Route::put("/asignar", [AuthController::class, "LoginEmpresa"]);
        Route::put("/test", [AuthController::class, "test"]);

        Route::get('/user/T3', [erp_UsuariosController::class, 'index']);
        ...
        // Route::get('/admin_user/T4', [erp_AdminUserController::class, 'index']);
        //idClient
        ...
        Route::put('/admin_user/T4/statusCompanie/{id}', [erp_AdminUserController::class, 'updateStatusByCompanie']);

        Route::get('/admin_main/T1', [erp_AdminController::class, 'index']);
        ...
        Route::get('su_administrador/crear/superadmin/{nombre}/{email}', [superadminController::class, 'index']);
        ...
        //id del usuario no del registro
        Route::post('/modulo_configuracion/modulosUsuario/{id}', [erp_permisos_modulosController::class, 'update']);
        Route::post('/modulo_configuracion/modulosUsuario', [erp_permisos_modulosController::class, 'create']);
        Route::put('/modulo_configuracion/modulosUsuario/{id}/changeStatus', [erp_permisos_modulosController::class, 'changeStatus']);
        Route::delete('/modulo_configuracion/modulosUsuario/{id}/delete', [erp_permisos_modulosController::class, 'destroy']);
        Route::get('/modulo_configuracion/modulosUsuario/{id}/show', [erp_permisos_modulosController::class, 'show']);

        /*MODULO    : CONFIGURACION*/
        /*MENU      : NAVBAR*/
        /*SUBMENU   : ESTRUCTURA*/
        /*VISTA     : DISEÑO MODULOS*/
        Route::get('/modulo_configuracion/diseno_modulos', [erp_modulosController::class, 'index'])->name("diseno_modulos.index");
        ...
        /*DISEÑO MENUS*/
        Route::get('/modulo_configuracion/diseno_menus/{id}/menus', [erp_menusController::class, 'index'])->name("diseno_menus.index");
        ...
        //DISEÑO SUBMENUS//
        Route::get('/modulo_configuracion/diseno_submenus/{id}/submenus', [erp_submenusController::class, 'index'])->name("diseno_submenus.index");
        ...
        // DISEÑO VISTAS//
        Route::get('/modulo_configuracion/diseno_vistas/vistas/{id}', [erp_vistasController::class, 'index'])->name("diseno_vistas.index");
        ...
        */
        ...
        Route::middleware(AdministradorEmpresaIsValid::class)->group(function () {
            Route::get("/administradores/empresa/roles", [gestionRolesController::class, 'get_roles']);
            Route::post("/administradores/empresa/roles", [gestionRolesController::class, 'crear_rol']);
            Route::post("/administradores/empresa/roles/actualizar", [gestionRolesController::class, 'modificar_roles']);
            Route::delete("/administradores/empresa/roles", [gestionRolesController::class, 'eliminar_roles']);
            Route::put("/administradores/empresa/roles", [gestionRolesController::class, 'activacion_roles']);
        });
